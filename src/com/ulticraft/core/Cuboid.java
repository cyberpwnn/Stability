...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable
{
	 ...
	 * amounts will
	 * shrink the Cuboid in the given direction. Shrinking a cuboid's face past
	 * the opposite face
	 ...
	 * E.g. a direction of Down will push the top face downwards as much as
	 * possible.
	 *
	 * @param dir
	 ...
	 * World. This
	 * version of getRelativeBlock() should be used if being called many times,
	 * to avoid
	...
	/**
	 * Set all the blocks in this cuboid to the given block ID and data byte,
	 * using
